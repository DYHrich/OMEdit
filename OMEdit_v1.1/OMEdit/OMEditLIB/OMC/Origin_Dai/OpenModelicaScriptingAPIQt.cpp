...
QString OMCInterface::getModelInstanceAnnotation(QString className, QList<QString > filter, modelica_boolean prettyPrint)
{
  ...
  qDebug() << "=== GetModelInstanceAnnotation FUNCTION CALLED ===";
  // qDebug() << "Parameter cl:" << cl;
  printf("=== Daiyuhang python PRINTF: getModelInstanceAnnotation called ===\n");
  QElapsedTimer commandTime;
  commandTime.start();
  QString commandLog;
  ...
  commandLog.append(prettyPrint ? "true" : "false");
  QString command("getModelInstanceAnnotation("+commandLog+")");
  emit logCommand(command);

  PythonInterpreter* sessionManager = PythonInterpreter::getInstance();
  QString result = sessionManager->executeCommand(command);
  ...
  std::cout << "  result (QString): " << result.toStdString() << std::endl;
  // printf(result);
...
{
  qDebug() << "=== GetInitialStates FUNCTION CALLED ===";
  qDebug() << "Parameter cl:" << cl;
  printf("=== Daiyuhang python PRINTF: getInitialStates called ===\n");
  QElapsedTimer commandTime;
  commandTime.start();
  QString commandLog;
  commandLog.append(cl);
  QString command("getInitialStates("+commandLog+")");
  emit logCommand(command);
  ...
  PythonInterpreter* sessionManager = PythonInterpreter::getInstance();
  QString result1 = sessionManager->executeCommand(command);

  std::cout << "  result1 (QString): " << result1.toStdString() << std::endl;
...
{
  qDebug() << "=== GetErrorString FUNCTION CALLED ===";
  qDebug() << "Parameter cl:" << warningsAsErrors;
  printf("=== Daiyuhang python PRINTF: getErrorString called ===\n");

  QElapsedTimer commandTime;
  commandTime.start();
  QString commandLog;
  commandLog.append(warningsAsErrors ? "true" : "false");
  QString command("getErrorString("+commandLog+")");
  emit logCommand(command);
...
{
  qDebug() << "=== GETVERSION FUNCTION CALLED ===";
  qDebug() << "Parameter cl:" << cl;
  printf("=== Daiyuhang python PRINTF: getVersion called ===\n");
  QElapsedTimer commandTime;
  commandTime.start();
  QString commandLog;
  commandLog.append(cl);
  QString command("getVersion("+commandLog+")");
  emit logCommand(command);
  ...
  try {
    ...
    result1 = QString::fromUtf8((char*)MMC_STRINGDATA(result_mm));
  ...
  emit logResponse(command, result, commandTime.elapsed());
  return result;
}
...
//   qDebug() << "=== GETVERSION FUNCTION CALLED ===";
//   qDebug() << "Parameter cl:" << cl;
//   printf("=== Daiyuhang PRINTF: getVersion called ===\n");
//   fflush(stdout);
...
{
  // qDebug() << "=== GetInstallationDirectoryPath FUNCTION CALLED ===";
  // printf("=== Daiyuhang python PRINTF: getInstallationDirectoryPath called ===\n");
  QElapsedTimer commandTime;
  commandTime.start();
  QString command("getInstallationDirectoryPath()");
  emit logCommand(command);
