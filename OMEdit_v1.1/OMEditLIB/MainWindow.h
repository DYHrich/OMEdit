...
// extern "C" {
// #include "SimulationRuntime_c/meta/meta_modelica.h"
// }
// #include "Util/OpenModelica_types_remove.h"
#include "SimulationRuntime_c/openmodelica_types.h"
...
class OMCProxy;
#ifndef OM_DISABLE_TRANSDE
class TransformationsWidget;
#endif
class LibraryWidget;
class ElementWidget;
#ifndef OM_DISABLE_DEBUGGER
class GDBAdapter;
