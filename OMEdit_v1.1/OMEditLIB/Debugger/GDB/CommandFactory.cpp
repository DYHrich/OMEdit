...
QByteArray CommandFactory::GDBSet(QString command) {
    std::cout << "QByteArray CommandFactory::GDBSet(QString command)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::attach(QString processID) {
    std::cout << "QByteArray CommandFactory::attach(QString processID)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::changeStdStreamBuffer() {
    std::cout << "QByteArray CommandFactory::changeStdStreamBuffer()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakInsert(QString fileName, int line, bool isDisabled, QString condition, int ignoreCount, bool isPending) {
    std::cout << "QByteArray CommandFactory::breakInsert(QString fileName, int line, bool isDisabled, QString condition, int ignoreCount, bool isPending)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakDelete(QStringList breakpointIDs) {
    std::cout << "QByteArray CommandFactory::breakDelete(QStringList breakpointIDs)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakEnable(QStringList breakpointIDs) {
    std::cout << "QByteArray CommandFactory::breakEnable(QStringList breakpointIDs)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakDisable(QStringList breakpointIDs) {
    std::cout << "QByteArray CommandFactory::breakDisable(QStringList breakpointIDs)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakAfter(QString breakpointID, int count) {
    std::cout << "QByteArray CommandFactory::breakAfter(QString breakpointID, int count)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::breakCondition(QString breakpointID, QString condition) {
    std::cout << "QByteArray CommandFactory::breakCondition(QString breakpointID, QString condition)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::execRun() {
    std::cout << "QByteArray CommandFactory::execRun()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::execContinue() {
    std::cout << "QByteArray CommandFactory::execContinue()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::execNext() {
    std::cout << "QByteArray CommandFactory::execNext()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::execStep() {
    std::cout << "QByteArray CommandFactory::execStep()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::execFinish() {
    std::cout << "QByteArray CommandFactory::execFinish()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::threadInfo() {
    std::cout << "QByteArray CommandFactory::threadInfo()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::stackListFrames(int thread) {
    std::cout << "QByteArray CommandFactory::stackListFrames(int thread)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::stackListVariables(int thread, int frame, QString printValues) {
    std::cout << "QByteArray CommandFactory::stackListVariables(int thread, int frame, QString printValues)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::createFullBacktrace() {
    std::cout << "QByteArray CommandFactory::createFullBacktrace()" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::dataEvaluateExpression(int thread, int frame, QString expression) {
    std::cout << "QByteArray CommandFactory::dataEvaluateExpression(int thread, int frame, QString expression)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::getTypeOfAny(int thread, int frame, QString expression, bool inRecord) {
    std::cout << "QByteArray CommandFactory::getTypeOfAny(int thread, int frame, QString expression, bool inRecord)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::anyString(int thread, int frame, QString expression) {
    std::cout << "QByteArray CommandFactory::anyString(int thread, int frame, QString expression)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::getMetaTypeElement(int thread, int frame, QString expression, int index, metaType mt) {
    std::cout << "QByteArray CommandFactory::getMetaTypeElement(int thread, int frame, QString expression, int index, metaType mt)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::arrayLength(int thread, int frame, QString expression) {
    std::cout << "QByteArray CommandFactory::arrayLength(int thread, int frame, QString expression)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::listLength(int thread, int frame, QString expression) {
    std::cout << "QByteArray CommandFactory::listLength(int thread, int frame, QString expression)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::isOptionNone(int thread, int frame, QString expression) {
    std::cout << "QByteArray CommandFactory::isOptionNone(int thread, int frame, QString expression)" << std::endl;
    return QByteArray();
}
...
QByteArray CommandFactory::GDBExit() {
    std::cout << "QByteArray CommandFactory::GDBExit()" << std::endl;
    return QByteArray();
}
