...
void BreakpointDialog::browseClasses() {
    std::cout << "void BreakpointDialog::browseClasses()" << std::endl;
}
...
void BreakpointDialog::browseFileSystem() {
    std::cout << "void BreakpointDialog::browseFileSystem()" << std::endl;
}
...
void BreakpointDialog::addOrEditBreakpoint() {
    std::cout << "void BreakpointDialog::addOrEditBreakpoint()" << std::endl;
}
